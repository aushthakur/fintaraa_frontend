    ...
    <main className="bg-white">
      ...
      <section className="px-4 py-10 md:px-6 lg:px-8">
        <div className="mx-auto max-w-9xl">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-[13px] font-black text-[#195585] no-underline shadow-[0_10px_28px_rgba(25,85,133,0.08)]"
          >
          ...
          <div className="mt-7 grid gap-8 lg:grid-cols-[1fr_0.82fr] lg:items-stretch">
            <div className="flex flex-col justify-center">
              ...
              <h1 className="mt-4 max-w-4xl text-[38px] font-black leading-[1.05] tracking-[-0.02em] text-[#07162d] md:text-[58px]">
                {post.title}
              </h1>
        ...
        <div className="mx-auto grid max-w-9xl gap-8 lg:grid-cols-[minmax(0,1fr)_22rem]">
          <article className="bg-white border border-gray-200 px-5 py-8 md:px-10 md:py-12">
              ...
              {post.body.map((section, index) => (
                <section key={section.heading}>
                  <div className="flex items-start gap-4">
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#eef8ff] text-[13px] font-black text-[#195585]">
                      {String(index + 1).padStart(2, "0")}
                    </span>
                    <div>
                      <h2 className="text-[28px] font-black leading-tight text-[#07162d]">
                        {section.heading}
                      </h2>
            ...
            <div className="mt-12 bg-[#f8fcff] p-5">
              ...
              <h3 className="mt-4 text-[22px] font-black text-[#07162d]">
                Fintaraa note
              </h3>
          ...
          <aside className="h-fit bg-white p-5 shadow-[0_18px_45px_rgba(25,85,133,0.08)] lg:sticky lg:top-28">
            ...
            <Link
              href="/blog"
              className="mt-6 inline-flex h-10 items-center gap-2 rounded-full bg-[#195585] px-4 text-[13px] font-black text-white no-underline"
            >
              View all blogs
