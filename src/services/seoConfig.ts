...
export const coreSitemapRoutes = [
  ...
  { path: "/banks", priority: 0.9, changeFrequency: "daily" },
  ...
  { path: "/msme-registration", priority: 0.82, changeFrequency: "weekly" },
  { path: "/annual-compliance", priority: 0.8, changeFrequency: "weekly" },
  { path: "/roc-filing", priority: 0.8, changeFrequency: "weekly" },
  { path: "/tax-compliance", priority: 0.8, changeFrequency: "weekly" },
  { path: "/project-report", priority: 0.8, changeFrequency: "weekly" },
  ...
  { path: "/knowledge-hub", priority: 0.72, changeFrequency: "daily" },
  { path: "/press-release", priority: 0.7, changeFrequency: "daily" },
  { path: "/video-testimonials", priority: 0.68, changeFrequency: "weekly" },
  { path: "/testimonials", priority: 0.66, changeFrequency: "weekly" },
  ...
  { path: "/refer-and-earn", priority: 0.65, changeFrequency: "weekly" },
  ...
  { path: "/application-status", priority: 0.5, changeFrequency: "weekly" },
  { path: "/faqs", priority: 0.52, changeFrequency: "monthly" },
