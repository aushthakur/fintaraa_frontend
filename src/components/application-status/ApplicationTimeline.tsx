...
const timeline = [
  ...
  { title: "Under Review", text: "Your application is under review.", done: true },
  {
    ...
    <section className="px-4 pb-12 md:px-6 lg:px-8">
      <div className="mx-auto max-w-9xl">
        ...
        <div className="mt-8 rounded-xl border border-[#d7dfe8] bg-white p-8">
          <div className="relative grid gap-9">
            ...
            {timeline.map(({ title, text, done, action }, index) => (
              <div key={title} className="relative grid gap-4 pl-20 md:grid-cols-[1fr_auto]">
                <span
                  className={`absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-full text-[20px] font-black text-white ${
                ...
                <div>
                  ...
                  {action ? (
                    <Link
                      ...
                      className="mt-4 inline-flex h-11 items-center justify-center rounded-full border border-[#13a653] px-7 text-[13px] font-black text-[#13a653] no-underline"
                    >
                      Upload Document
                    </Link>
                  ) : null}
        ...
        <div className="mt-8 flex flex-col gap-4 rounded-xl border border-[#b5d9f6] bg-[#e8f4ff] p-6 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            href="/support"
            className="inline-flex h-13 items-center justify-center rounded-full border border-[#13a653] px-8 text-[17px] font-black text-[#13a653] no-underline"
          >
