      ...
      <div className="mt-5 grid gap-3">
        {loading ? (
          <StateCard
            ...
            text="Please wait while we load recent support requests."
          />
        ) : error ? (
          <StateCard
            icon={AlertTriangle}
          ...
          <StateCard
            ...
            text="Create a ticket and it will appear here."
          />
        ) : (
          tickets.map((ticket) => {
              ...
              >
                ...
                <span className="flex items-start justify-between gap-3 pl-2">
                  <span className="min-w-0">
                    <span className="block truncate text-[15px] font-extrabold text-[#07162d]">
                      {ticket.title}
                    </span>
