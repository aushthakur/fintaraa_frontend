...
export default function PartnersByProductPage() {
  return (
    <main className="bg-white">
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#0d377f_0%,#092e77_45%,#082767_100%)] px-4 text-white md:px-6 lg:px-8">
        ...
        <div className="pointer-events-none absolute left-[34%] top-0 hidden h-full w-[360px] opacity-[0.18] md:block lg:w-[520px]">
        ...
        <div className="relative mx-auto flex max-w-9xl flex-col justify-center py-8 lg:h-[350px] lg:py-0">
          <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
            ...
            <div className="relative mx-auto flex min-h-[250px] w-full max-w-[520px] items-center justify-center lg:min-h-[300px]">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <Image
                  ...
                  height={240}
                  unoptimized
                  className="h-auto w-[280px] drop-shadow-[0_24px_40px_rgba(0,0,0,0.22)] sm:w-[315px] lg:w-[330px]"
                />
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-9xl rounded-[18px] border border-[#d9eafb] bg-[#eaf4ff] px-5 py-6 shadow-[0_18px_42px_rgba(16,24,40,0.06)] md:px-7">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-[84px] w-[84px] shrink-0 items-center justify-center rounded-2xl border border-dashed border-[#8bbbf0] bg-white/75 text-center text-[10px] font-bold uppercase tracking-[0.18em] text-[#407bd8]">
               <Image
  ...
  height={120}
  unoptimized
  className="h-[100px] w-[100px] object-contain sm:h-[110px] sm:w-[110px] lg:h-[120px] lg:w-[120px]"
/>
              </div>
              <div>
