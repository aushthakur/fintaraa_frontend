...
export function WhatsAppConsent({
  ...
  return (
    <div className={className}>
      <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-[#dce9f7] bg-[#f8fbff] px-3 py-3 text-left">
        <input
          type="checkbox"
          checked={checked}
          required
        ...
        />
        <span className="text-[12px] font-semibold leading-5 text-[#475467]">
