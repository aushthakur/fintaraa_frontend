              ...
              {[
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-[13px] font-extrabold ${
                    view === key ? "bg-[#5b21b6] text-white" : "text-[#5d7285]"
                  }`}
                >
                ...
                <>
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      disabled={tracking}
                      className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-[#5b21b6] px-5 text-[13px] font-extrabold text-white disabled:opacity-70"
                    >
                      {tracking ? (
                        <Loader2 className="h-4 w-4 animate-spin" />
                      ) : (
      ...
      <section className="overflow-hidden bg-[#f7fafc] px-4 py-14 md:px-6 md:py-18 lg:px-8">
        <div className="mx-auto max-w-9xl">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mt-4 text-[30px] font-extrabold tracking-tight text-[#3b0764] sm:text-[36px]">
            ...
            {[
              ...
              >
                <div className="relative z-10 flex items-center justify-between">
                  <span className="grid h-16 w-16 place-items-center rounded-2xl border-4 border-[#f7fafc] bg-[#5b21b6] text-white">
            ...
            <article className="rounded-3xl border border-[#dce7ef] bg-white p-5 sm:p-7">
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-3">
                {[
                  ...
                  >
                    <span className="absolute -left-1.75 top-0 h-3 w-3 rounded-full border-2 border-white bg-[#5b21b6]" />
              ...
              {legalPages.grievance.sections.map((section, index) => (
                ...
                >
                  <summary className="flex cursor-pointer list-none items-center gap-3">
                    <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[#eef5fb] font-mono text-[10px] font-extrabold text-[#5b21b6]">
                  ...
                  <p className="mt-4 border-t border-[#f5f3ff] pt-4 whitespace-pre-line text-[12px] font-medium leading-6 text-[#60778a]">
                    {section.body}
                  </p>
                </details>
              ))}
...
const fieldClass =
  "h-11 w-full rounded-xl border border-[#d8e3ed] bg-white px-3 text-[13px] font-semibold text-[#172033] outline-none transition placeholder:font-medium placeholder:text-[#9aa8b6] focus:border-[#5b21b6] focus:ring-3 focus:ring-[#5b21b6]/10";
  ...
  return (
    <div className="mt-6 space-y-4 border-t border-[#e6edf3] pt-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="font-mono text-[13px] font-extrabold text-[#5b21b6]">
