          ...
          <div className="mx-auto max-w-9xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {(products.length > 0
                ...
                const productApplyHref = isCreditCardProduct
                  ? detailsHref
                  : getApplyHref({
                      category: "loan",
                      bankSlug: page.bankSlug,
                      ...
                      referrer:
                        detailsHref ||
                        page.canonicalPath ||
                        `/banks/${page.bankSlug}/${page.productSlug}`,
                    });
                return (
                  <article
                    key={product.title}
                  ...
                  >
                    ...
                    {isCreditCardProduct ? (
                      ...
                      >
                        <span>{product.ctaLabel || "View Cards"}</span>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-[12px] font-medium leading-relaxed text-[#7a869a]">
                    Get the best loan offer from {page.bankName || "HDFC Bank"}{" "}
