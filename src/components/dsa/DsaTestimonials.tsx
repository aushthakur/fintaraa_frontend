        ...
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          {dsaTestimonials.map((item) => (
            ...
            >
              <div>
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#edf5ff] text-[13px] font-extrabold text-[#6d28d9]">
                      {initials(item.name)}
                    </span>
                    <span>
              ...
              <div className="mt-5 rounded-full bg-[#eaf3ff] px-4 py-2 text-center text-[12px] font-extrabold text-[#6d28d9]">
                {item.metric}
              </div>
            </article>
          ))}
