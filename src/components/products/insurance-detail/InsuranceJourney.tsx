  ...
  return (
    <section className="px-4 pb-10 md:px-6 lg:px-8">
      <div className="mx-auto grid max-w-9xl gap-8 bg-[#edf6ff] p-8 md:grid-cols-[1fr_0.9fr] md:items-center">
        <div>
          <h2 className="text-[24px] font-extrabold text-[#005ca8]">
            Your Journey to
          ...
          <AuthRedirectLink
            href={applyHref}
            productSlug={insuranceTypeSlug}
            className="mt-6 inline-flex h-10 items-center justify-center bg-[#005ca8] px-5 text-[12px] font-extrabold text-white no-underline"
          >
            Start Your Application Now
          </AuthRedirectLink>
        </div>
        <div className="rounded bg-white p-5 shadow-[0_18px_40px_rgba(0,92,168,0.12)]">
          <div className="mb-4 flex items-center gap-2 text-[12px] font-extrabold text-[#005ca8]">
