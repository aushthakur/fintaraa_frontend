          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-[14px] text-gray-700">
              <div className="border-b border-gray-100 pb-3">
                ...
                <p className="text-gray-600 text-xs sm:text-[13.5px]">
              ...
              <div className="border-b border-gray-100 pb-3">
                ...
                <p className="text-gray-600 text-xs sm:text-[13.5px]">
                  Employees of <strong>Category 1 companies</strong> (e.g. Genpact, TCS, Infosys, Wipro, Accenture, Reliance) enjoy pre-approved limits up to ₹1 Crore, priority 24-hr processing, and the lowest starting rates from 10.49%.
                </p>
              </div>
        ...
        <div className="mt-16 sm:mt-24 pt-12 border-t border-gray-200/80">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="border-l-2 border-emerald-500 pl-4 py-1">
              <span className="text-2xl font-black text-emerald-600">750+</span>
              <h4 className="font-bold text-gray-900 text-sm mt-1">Excellent / Prime Tier</h4>
            ...
            <div className="border-l-2 border-blue-500 pl-4 py-1">
              <span className="text-2xl font-black text-blue-600">700 – 749</span>
              <h4 className="font-bold text-gray-900 text-sm mt-1">Good Tier</h4>
              <p className="text-xs text-gray-600 mt-1 leading-relaxed">
            ...
            <div className="border-l-2 border-amber-500 pl-4 py-1">
              <span className="text-2xl font-black text-amber-600">650 – 699</span>
              <h4 className="font-bold text-gray-900 text-sm mt-1">Average / Moderate</h4>
              <p className="text-xs text-gray-600 mt-1 leading-relaxed">
            ...
            <div className="border-l-2 border-red-500 pl-4 py-1">
              <span className="text-2xl font-black text-red-500">&lt; 650</span>
              <h4 className="font-bold text-gray-900 text-sm mt-1">Poor / High Risk</h4>
              <p className="text-xs text-gray-600 mt-1 leading-relaxed">
        ...
        <div className="mt-12 rounded-3xl bg-white p-6 sm:p-8 border border-gray-100 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="my-3 rounded-xl bg-slate-50 px-4 py-2.5 font-mono text-xs font-bold text-gray-800 inline-block">
                FOIR = (Total Current Monthly EMIs + Proposed New EMI) ÷ Net Monthly Income × 100
              </div>
              <p className="text-xs text-gray-500 leading-relaxed">
                <strong>Optimal Target:</strong> Keep your total FOIR below <strong>50%</strong>. For applicants with monthly income above ₹1.5 Lakhs, select banks permit a FOIR up to 65%, enabling personal loans up to ₹1 Crore.
              </p>
            </div>
          </div>
        </div>
