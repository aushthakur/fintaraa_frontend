  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between gap-4 mb-2">
              <label htmlFor={amountSliderId} className="text-sm font-bold text-slate-700">
                Required Loan Amount
              </label>
              <div className="flex items-center gap-1 text-lg sm:text-xl font-extrabold text-[#5b21b6]">
                <span>₹</span>
          ...
          <div>
            <div className="flex items-center justify-between gap-4 mb-2">
              <label htmlFor={rateSliderId} className="text-sm font-bold text-slate-700">
                Interest Rate (p.a.)
              </label>
              <div className="text-lg sm:text-xl font-extrabold text-[#5b21b6]">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 mt-2">
              {tenureOptions.map((year) => (
                <button
                  ...
                  className={`py-2.5 px-2 text-center text-xs font-bold rounded-xl transition-all cursor-pointer ${
                    tenureYears === year
        ...
        <div className="lg:col-span-5 bg-slate-50/70 p-6 sm:p-8 rounded-3xl">
          
          <p className="text-xs font-extrabold uppercase tracking-wider text-slate-400">
            Estimated Monthly Payment
          </p>
          <div className="mt-1 flex items-baseline gap-1 text-3xl sm:text-4xl font-extrabold text-slate-900">
          ...
          <div className="mt-6 space-y-3 pt-6 border-t border-slate-200">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-bold text-[#5b21b6]">₹{totalInterest.toLocaleString("en-IN")}</span>
            </div>
            <div className="flex justify-between items-center text-sm pt-2 border-t border-slate-200">
              <span className="text-slate-900 font-bold">Total Amount Payable</span>
              <span className="font-extrabold text-slate-900 text-base">₹{totalAmount.toLocaleString("en-IN")}</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-between text-xs font-semibold mt-2 text-slate-500">
          ...
          <div className="mt-8">
            <AuthRedirectLink
              ...
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#5b21b6] py-3.5 px-6 text-sm font-bold text-white shadow-md transition-all hover:bg-[#4c1d95] active:scale-[0.98]"
            >
      ...
      <div className="mt-16 pt-12 border-t border-slate-200">
        <div className="max-w-3xl mb-8">
          ...
          <p className="mt-2 text-sm text-slate-600 leading-relaxed">
            Many private lenders advertise an attractive “7% to 8% flat interest rate”. In reality, a <strong>7% flat rate is equivalent to approximately 13.5% to 14.5% reducing rate</strong>, because in a flat rate loan, interest is calculated on the entire original principal for the full tenure, even after you have repaid 80% of the loan!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-base font-bold text-slate-900">Reducing Balance Rate (Standard on Fintaraa)</h4>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-base font-bold text-slate-900">Flat Interest Rate Trap (Misleading Offline Loans)</h4>
            </div>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
