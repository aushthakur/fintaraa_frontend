...
const bands = [
  {
    range: "750 - 900",
    label: "Excellent",
    text: "You are a low-risk borrower",
    color: "bg-[#00c800]",
    textColor: "text-[#00c800]",
  },
  {
    range: "650 - 749",
    label: "Good",
    text: "You are a reliable borrower",
    color: "bg-[#6be66b]",
    textColor: "text-[#59cc59]",
  },
  {
    range: "550 - 649",
    label: "Average",
    text: "You may face limited options",
    color: "bg-[#ffcc00]",
  ...
  },
  {
    range: "300 - 549",
    label: "Poor",
    text: "You are a high risk borrower",
    color: "bg-[#ff2b14]",
    textColor: "text-[#ff2b14]",
  },
];
...
const steps = [
  {
    ...
    visual: (
      <div className="relative flex items-center justify-center h-12 w-10 border-2 border-[#005ca8] rounded-md bg-white">
        ...
        <span className="text-[9px] font-bold text-[#005ca8] bg-white px-0.5 shadow-xs border border-gray-100 z-10 whitespace-nowrap">
          +91
        </span>
  ...
  return (
    <>
      ...
      <section className="bg-white px-4 py-10 md:px-6 lg:px-8">
        <div className="mx-auto max-w-9xl rounded-2xl border border-gray-200 bg-white px-6 py-10 text-center shadow-[0_4px_24px_rgba(0,0,0,0.01)] md:px-12">
          ...
          <p className="mt-2.5 text-[14px] font-medium text-gray-500 max-w-md mx-auto leading-relaxed">
            CIBIL Score is a 3 digit number that represents your credit
            worthiness
          </p>
          ...
          <div className="mt-10 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {bands.map((item) => (
              ...
              >
                ...
                <div
                  className={`${item.color} w-full h-16 flex items-center justify-center text-[15px] font-bold text-black select-none rounded-2`}
                >
                  {item.range}
                </div>
                ...
                <h3
                  className={`mt-3 text-[14px] font-bold ${item.textColor} tracking-tight`}
                >
                  {item.label}
                </h3>
