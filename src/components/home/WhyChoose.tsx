      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex items-center justify-between gap-6 pb-8">
          ...
          <div className="relative hidden sm:flex items-center justify-center">
            ...
            <span className="absolute -left-6 bottom-1 text-[18px] opacity-40 select-none">🏛️</span>
            <span className="absolute -right-6 top-1 text-[18px] opacity-40 select-none">📄</span>
          </div>
        </div>
