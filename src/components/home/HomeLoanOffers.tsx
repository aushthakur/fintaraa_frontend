...
// Mock data structured to match the visual arrangement in image_a1c8bd.png
const loanOffersData: LoanRateOffer[] = [
  { id: "sbi-1", bankName: "SBI Bank", logoSrc: "/assets/banks/visa-card.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "icici-1", bankName: "ICICI Bank", logoSrc: "/assets/banks/icici.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "kotak-1", bankName: "Kotak Bank", logoSrc: "/assets/banks/kotak.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "indus-1", bankName: "IndusInd Bank", logoSrc: "/assets/banks/idfc.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "sbi-2", bankName: "SBI Bank", logoSrc: "/assets/banks/visa-card.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "icici-2", bankName: "ICICI Bank", logoSrc: "/assets/banks/icici.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "kotak-2", bankName: "Kotak Bank", logoSrc: "/assets/banks/kotak.png", minRate: "7.8%", maxRate: "9.8%" },
  { id: "indus-2", bankName: "IndusInd Bank", logoSrc: "/assets/banks/idfc.png", minRate: "7.8%", maxRate: "9.8%" },
];
      ...
      <div className="mx-auto max-w-9xl rounded-3xl border border-gray-200 p-6 md:p-10 shadow-[0_4px_30px_rgba(0,0,0,0.015)]">
        ...
        <div className="flex gap-2 overflow-x-auto pb-3 scrollbar-none">
          {productTabs.map((tab, idx) => {
            const isSelected = activeTab === tab && idx === 0;
            return (
              <button
                key={`${tab}-${idx}`}
                type="button"
