          ...
          <motion.div {...reveal(0.08)}>
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 text-[14px] font-extrabold leading-6 text-[#075cde] md:text-[15px]">
                Founder & CEO, Xpertserve Services Pvt. Ltd. (Fintaraa)
              </p>
            ...
            <div className="mt-10 grid gap-x-8 gap-y-5 sm:grid-cols-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-[12px] font-semibold leading-6 text-[#4f6278] md:text-[13px]">
                  Corporate Office: Office No. 205, Workbox Building, Railway
                  Road, NIT 5, Near Capital Hyundai Showroom, Faridabad, Haryana
                  121001
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Target className="mt-1 h-4.5 w-4.5 shrink-0 text-[#075cde]" />
                <p className="text-[12px] font-semibold leading-6 text-[#4f6278] md:text-[13px]">
                  Branch 2: Shop No. D-003, Ground Floor, Puri Business Hub,
                  Sec-81 High Street, Faridabad, Haryana 121002
                </p>
              </div>
            </div>
          </motion.div>
