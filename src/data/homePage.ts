...
export const productSections = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        tone: "blue",
        href: "/banks/kotak-mahindra-bank",
      },
      {
        title: "SBI Bank",
  ...
  },
  {
    ...
    products: [
      ...
      {
        title: "Vehicle Loan",
        text: "Finance a new or used vehicle with manageable EMIs.",
        icon: Car,
        tone: "red",
      },
      {
        title: "Education Loan",
        text: "Fund tuition and study costs in India or abroad.",
        icon: GraduationCap,
        tone: "green",
      },
      {
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        text: "Protect inventory from fire, theft, water and damage.",
        icon: PackageCheck,
        tone: "pink",
      },
      {
        title: "Term Insurance",
        text: "High life cover to protect your family's income.",
        icon: ShieldCheck,
        tone: "sky",
      },
      {
